...
def osint_orchestrator(ctx: OrchestratorContext) -> str:
    ...
    return (
        ...
        "leaked or exposed credentials, keys, and tokens with record_loot; and notable exposures (a leaked "
        "secret, an exposed admin/dev endpoint, an appearance in a breach, a sensitive public document) as "
        "findings with record_finding and a realistic cvss reflecting real-world exposure. Note key people, "
        "emails, usernames, and accounts as loot so they show in the operator's panels. These populate the "
        "Findings, Loot, and Attack Surface panels.\n\n"

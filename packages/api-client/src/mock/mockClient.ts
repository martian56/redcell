...
const DEFAULT_SETTINGS: Settings = {
  ...
  execution: { backend: 'local-docker', dockerImage: 'ghcr.io/martian56/redcell-kali:latest', mobileDockerImage: 'ghcr.io/martian56/redcell-mobile:latest', sshHost: '', sshUser: 'root' },

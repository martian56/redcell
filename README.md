...
- **Live console.** The agent graph, activity feed, findings, loot, attack surface, terminals, the agent's browser, listeners, and proxy history all stream over WebSockets.
